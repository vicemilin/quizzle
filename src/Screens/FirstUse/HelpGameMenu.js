...
export default class HelpGameMenu extends PureComponent{
  constructor(props){
    super(props)
  ...
  btnNextPressed = () => {
    Actions.push('HelpGame', {player: this.props.player})
  }
    ...
    return(
      <ImageBackground source = {bgImage} style = {styles.mainContainer}>
        ...
        <View style = {styles.container}>
          <Text style = {styles.btnText}>This is a HelpGameMenu Screen</Text>
        </View>
