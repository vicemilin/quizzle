...
export default class HelpGame extends PureComponent{
  constructor(props){
    super(props)
  ...
  btnNextPressed = () => {
    Actions.push('ChooseCategories', {player: this.props.player, firstUse: true})
  }
    ...
    return(
      <ImageBackground source = {bgImage} style = {styles.mainContainer}>
        ...
        <View style = {styles.container}>
          <Text style = {styles.btnText}>This is a HelpGame Screen</Text>
        </View>
